        ...
        <div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5">
            <div class="container py-5">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">HCT GlobalLaps</h1>
                            <p class="text-secondary mb-0">@hoangcongtung</p>
                        </a>
                        <!-- </div>
                <div class="col-lg-6">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            <a href="https://www.facebook.com/hoang.cong.tung.602315/" target="_blank"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            <a href="https://www.facebook.com/hoang.cong.tung.602315/" target="_blank"
                                style="color: white;">My Account</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Address: 36, Lê Thanh Nghị, Hai Bà Trưng, Hà Nội</p>
                            <p>Email: tungdhbkhn2004@gmail.com</p>
                            <p>Phone: 0362456428</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Hoàng
                                Công
                                Tùng</a>, All right reserved.</span>
                    </div>
